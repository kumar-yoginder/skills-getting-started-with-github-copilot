...
activities = {
    "Basketball": {
        "description": "Indoor basketball league and skill development",
        ...
        "Art Studio": {
        "description": "Painting, sketching, and visual art techniques",
...
# Endpoint to unregister (delete) a participant from an activity
